...
content = content.replace(/<div className="text-\[11px\] text-slate-500 leading-tight hidden text-balance sm:block w-full text-left mt-1">/g, '<div className="text-sm md:text-base text-slate-500 mt-1">');
...
console.log('Done modifying node execution attempt');
